...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, AppointmentNotificationRequest> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AppointmentNotificationRequest> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, AppointmentNotificationRequest> factory = new ConcurrentKafkaListenerContainerFactory<>();
